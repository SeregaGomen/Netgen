...
public:
    ...
    virtual ~CSGView();
    void setRotating(bool isAutoRotate) { params.isAutoRotate = isAutoRotate; }
    bool getRotating(void) { return params.isAutoRotate; }
    ImageParams *getParams(void) { return &params; }
